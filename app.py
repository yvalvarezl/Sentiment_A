...
# Crear dos columnas: col1 para la animación y col2 para los títulos
col1, col2 = st.columns([1, 3])

with col1:
    # Usamos st_lottie e indicamos un ancho apropiado para estar al lado del título
    st_lottie(animation, width=150, key="emoji_anim")
